        ...
        <div>
          ...
          <div className="profile-address-section">
            <div className="d-flex align-items-center">
              <h4 className="">
                {user.address[user.primaryAddress].addressName}
              </h4>
            </div>
            <hr></hr>
              ...
              <div className="profile-address">
                <ul>
                  ...
                  <li>
                    <p>
                      <b>Phone:</b>{" "}
                      {user.address[user.primaryAddress].phoneNumber}
                    </p>
                  </li>
                  <li>
                    <p>
                ...
                <div className="address-options button">
                  ...
                  <button
                    ...
                    data-bs-target={
                      "#collapse" + user.primaryAddress.toString()
                    }
                    aria-expanded="false"
                ...
                <div className="checkout-steps-form-style">
                  ...
                  >
                    Edit Address
                        ...
                        <section
                          className=" collapse"
                          id={"collapse" + user.primaryAddress.toString()}
            ...
            index !== user.primaryAddress && (
              <div key={index}>
                <div className="purchase-row-banner d-flex justify-content-between d-flex align-items-center">
                  ...
                  {/* <h6 className="purchase-order-status"></h6> */}
                </div>
                <div className="profile-address-section">
                  <div className="d-flex align-items-center">
                    <h4 className="">{address.addressName}</h4>
                  </div>
                  <hr></hr>
                  <div className="addresses">
                    <div className="profile-address">
